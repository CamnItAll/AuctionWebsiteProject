...
public class CatalogueController {
    ...
    public String viewCatalog(@RequestParam(value = "keyword", required = false) String keyword, Model model) {
        List<Item> items = (keyword != null) ? catalogueService.searchAuctions(keyword) : catalogueService.searchAuctions("N/A");
    ...
    public String createNewAuction(@ModelAttribute Item item, @RequestParam String endDate, Principal principal) {
